...
function verdad() {
    ...
    array = [
        ...
        '¿Cuál es el lugar más extraño donde has tenido S€x0?',
        ...
        '¿Alguna vez has oído a tus padres teniendo S€x0?',
        '¿Te han pillado alguna vez teniendo S€x0?',
        '¿Cuál es el rumor más extraño que has escuchado sobre ti?',
        '¿Qué harías si fueras del S€x0 opuesto durante un mes?',
